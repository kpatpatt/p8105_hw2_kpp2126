...
trashwheel_df =
  ...
  mutate(sports_balls = round(sports_balls),
         ...
         homes_powered = as.integer(homes_powered)) %>% #made this the same as professor df to keep sameness before binding
...
professortrashwheel_df =
  ...
  mutate(homes_powered = round(homes_powered),
         ...
         year = as.character(year)) %>% #does this need to be the same as trashwheel?
...
skimr::skim(professortrashwheel_df)
